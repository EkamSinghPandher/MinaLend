...
import { PublicKey, Struct, Field } from "o1js";
...
export class Offer extends Struct({
    ...
    lenderNonceHash: Field,                       // nonceHash = hash(nonce), nonce is a random number generated by the lender
    nullifier: Field,                       // nullifier = hash(identity, nonce)
}) { }
